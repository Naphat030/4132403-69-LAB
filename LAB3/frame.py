"""แสดงโครงสร้างข้อมูลที่ถูกส่งผ่านเครือข่าย (Application / TCP / IP / Link Layer)

หมายเหตุ: Python socket ทำงานที่ระดับ Application เท่านั้น ระบบปฏิบัติการเป็นผู้
ประกอบ header ของ TCP และ IP ให้ โมดูลนี้จึง "จำลอง" header เหล่านั้นขึ้นมาใหม่
จากข้อมูลจริงของ socket (IP/port/ขนาด payload) เพื่อให้เห็นภาพว่าข้อมูลถูกห่อ
(encapsulate) เป็นชั้น ๆ อย่างไรก่อนออกสู่สาย และถูกแกะ (decapsulate) อย่างไรตอนรับ
"""
